...
export default function GroupCard({ group }) {  const { id, name, coverPhoto, memberCount, privacy, description } = group;
  ...
  return (
    <div className="bg-white rounded-lg shadow overflow-hidden">
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-500 mb-2">{memberCount.toLocaleString()} member{memberCount !== 1 ? 's' : ''}</p>
